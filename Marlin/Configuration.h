...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { { 140, 55 }, { 55, 140 } } // A pair of angles for { E0, E1 }.
                                                    // For Dual Servo use two pairs: { { lower, raise }, { lower, raise } }
  #define SWITCHING_NOZZLE_SERVO_DWELL 125          // Dwell time to wait for servo to make physical move
#endif
...
#define HOTEND_OFFSET_X { 0.0, -41.40 } // (mm) relative X-offset for each nozzle
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 189 // X_CENTER  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 197 // Y_CENTER  // (mm) Y point for Z homing
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_STROKES     1    // Default number of pattern repetitions
...
#define SERVO_DELAY { 150, 150, 150 } // 0: BLTouch, 1: 1st nozzle , 2:- 2nd nozzle
