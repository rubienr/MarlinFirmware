...
//   sm/c = 80.0
// Z steps example: steps per revolution s=200, microstepping m=16, effective spindle thread distance d=2.00
//   sm/d = 800.0
...
#define MY_X_STEPPER_STEP_DEGREE 1.8
#define MY_Y_STEPPER_STEP_DEGREE 1.8
#define MY_Z_STEPPER_STEP_DEGREE 1.8
#define MY_E_STEPPER_STEP_DEGREE 1.8
#define MY_E_EFFECTIVE_COGWHEEL_DIAMETER 7.22
#define MY_X_STEPS_PER_REVOLUTION (360.0/MY_X_STEPPER_STEP_DEGREE)
#define MY_Y_STEPS_PER_REVOLUTION (360.0/MY_Y_STEPPER_STEP_DEGREE)
#define MY_Z_STEPS_PER_REVOLUTION (360.0/MY_Z_STEPPER_STEP_DEGREE)
#define MY_E_STEPS_PER_REVOLUTION (360.0/MY_E_STEPPER_STEP_DEGREE)

#define DEFAULT_AXIS_STEPS_PER_UNIT   { \
    ((MY_X_STEPS_PER_REVOLUTION*MY_X_MICROSTEPS)/40.0),     \
    ((MY_Y_STEPS_PER_REVOLUTION*MY_Y_MICROSTEPS)/40.0),     \
    ((MY_Z_STEPS_PER_REVOLUTION*MY_Z_MICROSTEPS)/2.0),      \
    ((MY_E_STEPS_PER_REVOLUTION*MY_E_MICROSTEPS)/(3.141592654 * MY_E_EFFECTIVE_COGWHEEL_DIAMETER)) }
...
#define Z_AFTER_HOMING  (2.55 + 5)      // (mm) Height to move to after homing Z
