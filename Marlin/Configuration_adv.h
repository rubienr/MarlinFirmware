...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  49.0        // (Hz) The default dominant resonant frequency on the X axis.
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.08, 0.08 } // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
