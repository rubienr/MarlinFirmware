...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN       230 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
 ...
 */
  ...
  //#define TOOLCHANGE_FILAMENT_SWAP
    ...
    #define TOOLCHANGE_FS_EXTRA_RESUME_LENGTH 0.125 // (mm) Extra length for better restart. Adjust with LCD or M217 B.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH          6  // (mm) Length to extrude after loading.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  1350       // (mA) RMS current for sensorless homing
   ...
   */
  //TODO rubienr - check commits
  // https://github.com/MarlinFirmware/Marlin/commit/253ee0c407120526b821c0f3251bda0afb69d934
  // https://github.com/MarlinFirmware/Marlin/commit/bca4652c5e48415cf478da229a253a2106da3e59
 ...
 *
 * M810 position T0 (absolute)
 * M811 position T1 (absolute)
 * M812 prime: prime, blob and cut (relative to current position)
 * M813 prime tool T0: position + prime
 * M814 prime tool T1: position + prime
 * M815 prime tools: T1 then T0
 * M816 clean and prime T0
 * M817 clean and prime T1+T0
