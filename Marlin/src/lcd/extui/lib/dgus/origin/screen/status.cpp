...
#endif
#if HOTENDS >= 3
      to_address(dgus::memory_layout::Temperatures::E2Is), to_address(dgus::memory_layout::Temperatures::E2Set),
#endif
#if HOTENDS >= 4
...
#endif
      to_address(dgus::memory_layout::Position::X), to_address(dgus::memory_layout::Position::Y),
      to_address(dgus::memory_layout::Position::Z), to_address(dgus::memory_layout::FeedRate::Percentage),
