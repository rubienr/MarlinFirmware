...
#include "./origin_ui/DGUSDisplayDef.h"
#elif ENABLED(DGUS_LCD_UI_FYSETC)
#warning "DGUS_LCD_UI_FYSETC not implemented in DGUS_NG (disable DGUS_NG)."
#elif ENABLED(DGUS_LCD_UI_HIPRECY)
#include "DGUS_LCD_UI_HIPRECY not implemented in DGUS_NG (disable DGUS_NG)."
#endif
