...
const struct DGUS_VP_Variable ListOfVP[] PROGMEM {
  ...
  VPHELPER(dgus::memory_layout::ScreenAction::ScreenChange,
           nullptr,
           dgus::DGUSScreenVariableHandler::ScreenChangeHook,
           nullptr),
      VPHELPER(dgus::memory_layout::ScreenAction::ScreenChangeAsk,
               nullptr,
               dgus::DGUSScreenVariableHandler::ScreenChangeHookIfIdle,
               nullptr),

#if ENABLED(DGUS_ORIGIN_SDFILES)
      VPHELPER(dgus::memory_layout::ScreenAction::ScreenchangeIfSd,
               nullptr,
               dgus::DGUSScreenVariableHandler::ScreenChangeHookIfSD,
               nullptr),
#endif
      VPHELPER(dgus::memory_layout::ScreenAction::UserConfirmed,
               nullptr,
               dgus::DGUSScreenVariableHandler::ScreenConfirmedOK,
               nullptr),

      VPHELPER(dgus::memory_layout::ScreenAction::AllHeaderOff,
               nullptr,
               &dgus::DGUSScreenVariableHandler::HandleAllHeatersOff,
               nullptr),
      ...
      {.VP = to_address(dgus::memory_layout::UiVersion::Flavour),
       ...
       .set_by_display_handler = nullptr,
       .send_to_display_handler = &dgus::DGUSScreenVariableHandler::DGUSLCD_SendStringToDisplayPGM},
      ...
      {.VP = to_address(dgus::memory_layout::LcdMessage::M117),
       ...
       .set_by_display_handler = nullptr,
       .send_to_display_handler = &dgus::DGUSScreenVariableHandler::DGUSLCD_SendStringToDisplay},
...
#define HOTENDS_VPHELPER(N)                                                                                           \
  VPHELPER(                                                                                                           \
      dgus::memory_layout::PositionE::E##N, nullptr, &dgus::DGUSScreenVariableHandler::HandleManualExtrude, nullptr), \
      VPHELPER(                                                                                                       \
          dgus::memory_layout::MoveE::E##N, nullptr, &dgus::DGUSScreenVariableHandler::HandleManualExtrude, nullptr),
          REPEAT(HOTENDS, HOTENDS_VPHELPER)
#undef HOTENDS_VPHELPER
#endif // HOTENDS
...
#define HOTENDS_VPHELPER(N)                                                 \
  VPHELPER(dgus::memory_layout::StepsPerMm::E##N,                           \
           ...
           dgus::DGUSScreenVariableHandler::HandleStepPerMMExtruderChanged, \
           dgus::DGUSScreenVariableHandler::DGUSLCD_SendFloatAsIntValueToDisplay<1>),
              REPEAT(HOTENDS, HOTENDS_VPHELPER)
#undef HOTENDS_VPHELPER
#endif // HOTENDS
...
// TODO rubienr - fix define
      ...
      VPHELPER(VP_BED_PID_P,
               ...
               dgus::DGUSScreenVariableHandler::HandleTemperaturePIDChanged,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SendTemperaturePID),
...
// fan control, rate and status
      ...
      VPHELPER(dgus::memory_layout::PositionAxis::X,
               &current_position.x,
               nullptr,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SendFloatAsLongValueToDisplay<2>),
      ...
      VPHELPER(dgus::memory_layout::PrintStats::PrintProgressPercentage,
               nullptr,
               nullptr,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SendPrintProgressToDisplay),
#endif
  // print time
      ...
      VPHELPER_STR(dgus::memory_layout::PrintStats::PrintAccTime,
                   ...
                   nullptr,
                   dgus::DGUSScreenVariableHandler::DGUSLCD_SendPrintAccTimeToDisplay),
      VPHELPER_STR(dgus::memory_layout::PrintStats::PrintsTotal,
                   nullptr,
                   dgus::memory_layout::PrintStats::PrintsTotalBytes,
                   nullptr,
                   dgus::DGUSScreenVariableHandler::DGUSLCD_SendPrintsTotalToDisplay),
#endif
      ...
      VPHELPER(dgus::memory_layout::StepsPerMm::X,
               ...
               dgus::DGUSScreenVariableHandler::HandleStepPerMMChanged,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SendFloatAsIntValueToDisplay<1>),
...
// TODO rubienr
      ...
      VPHELPER(dgus::memory_layout::SdAction::ScrollEvent,
               nullptr,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SD_ScrollFilelist,
               nullptr),
      VPHELPER(dgus::memory_layout::SdAction::FileSelected,
               nullptr,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SD_FileSelected,
               nullptr),
      VPHELPER(dgus::memory_layout::SdAction::FileSelectConfirm,
               nullptr,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SD_StartPrint,
               nullptr),
      VPHELPER_STR(dgus::memory_layout::SdFileListing::FileName0,
                   nullptr,
                   to_uint16_t(dgus::memory_layout::SdFileListing::FileNameBytes),
                   nullptr,
                   dgus::DGUSScreenVariableHandler::DGUSLCD_SD_SendFilename),
      ...
      VPHELPER(dgus::memory_layout::SdAction::ResumePauseAbort,
               nullptr,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SD_ResumePauseAbort,
               nullptr),
      VPHELPER(dgus::memory_layout::SdAction::AbortPrintConfirmed,
               nullptr,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SD_ReallyAbort,
               nullptr),
      VPHELPER(dgus::memory_layout::SdAction::Print_Setting,
               nullptr,
               dgus::DGUSScreenVariableHandler::DGUSLCD_SD_PrintTune,
               nullptr),
#if HAS_BED_PROBE
#if ENABLED(BABYSTEPPING)
      VPHELPER(dgus::memory_layout::SdAction::Print_LiveAdjustZ,
               nullptr,
               dgus::DGUSScreenVariableHandler::HandleLiveAdjustZ,
               nullptr),
#endif
#endif
#endif
...
// TODO rubienr - DGUSLCD_SendWaitingStatusToDisplay implementation is missing
      ...
      VPHELPER(dgus::memory_layout::ScreenStatus::Waiting,
               nullptr,
               nullptr,
               &dgus::DGUSScreenVariableHandler::DGUSLCD_SendWaitingStatusToDisplay),
#endif
...
// nozzle to probe offset
      ...
      VPHELPER(dgus::memory_layout::OffsetNozzleToProbe::Nozzle0X,
               ...
               &dgus::DGUSScreenVariableHandler::DGUSLCD_SendFloatAsIntValueToDisplay<2>),
