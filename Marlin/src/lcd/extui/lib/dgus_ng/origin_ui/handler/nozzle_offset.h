 ...
 * @param val_ptr
 */
void handle_probe_offset_request(dgus::DGUS_VP_Variable &var, void *val_ptr);
/**
 ...
 * @param val_ptr
 */
template <ExtUI::axis_t axis> void handle_set_probe_offset_axis(dgus::DGUS_VP_Variable &var, void *val_ptr);
/**
 ...
 * @param val_ptr
 */
void handle_set_probe_offset_z_axis(dgus::DGUS_VP_Variable &var, void *val_ptr);
