 ...
 */
void handle_heating_status(dgus::DGUS_VP_Variable &var, void *val_ptr);
 ...
 * @param val_ptr must not be nullptr
 */
void handle_set_hotend_temperature(dgus::DGUS_VP_Variable &var, void *val_ptr);
 ...
 * @param val_ptr must not be nullptr
 */
void handle_set_bed_temperature(dgus::DGUS_VP_Variable &var, void *val_ptr);
...
/**struct dgus:: DGUS_VP_Variable;
 * Handles flags defined in CachedState::Control.
 * @param var var.memadr must not be nullptr
 * @param val_ptr must not be nullptr
 */
void handle_temperature_control_command(dgus::DGUS_VP_Variable &var, void *val_ptr);

/**
 * Sends the selected hotend's temperature to display.
 * @param var unused
 */
void handle_send_hotend_temperature_to_display(dgus::DGUS_VP_Variable &var);
